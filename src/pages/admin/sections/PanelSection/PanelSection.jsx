    ...
    <section className="panel-section">
      <div className="panel-section__header">
        <div>
          ...
          <h1 className="panel-section__title">Panel Administrativo</h1>
      ...
      <div className="panel-metrics">
        ...
        <MetricCard
          tipo="success"
          icon="users"
          valor={(metricas.usuariosActivos ?? 0).toLocaleString("es-BO")}
          titulo="Usuarios activos"
          detalle={`${metricas.estudiantes ?? 0} estudiantes · ${metricas.docentes ?? 0} docentes`}
        />
        ...
        <MetricCard
          tipo="danger"
          icon="download"
          valor={(metricas.totalDescargas ?? 0).toLocaleString("es-BO")}
          titulo="Descargas"
              ...
              <tbody>
                {solicitudes.length === 0 ? (
                  ...
                  solicitudes.map((solicitud) => (
                    <tr key={solicitud.id || solicitud.id_solicitud}>
                      <td>
                        <strong>
      ...
      <div className="quick-panel">
        <QuickAction
          ...
          descripcion="Registrar, editar y organizar recursos digitales."
          boton="Gestionar libros"
          onClick={() => onNavigate("Gestionar Libros")}
        />
        ...
        <QuickAction
          ...
          descripcion="Administrar carreras, materias y áreas básicas."
          boton="Ver carreras"
